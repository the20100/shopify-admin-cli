...
// update self-updates the shopify-admin-cli binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/shopify-admin-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update shopify-admin-cli to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "shopify-admin-cli-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "shopify-admin-cli")
